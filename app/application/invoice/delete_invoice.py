...
class DeleteInvoiceUseCase:
    ...
    def execute(self, invoice_id: UUID) -> None:
        ...
        if invoice.is_auto_generated:
            raise AutoGeneratedInvoiceError(invoice_id)

        # Reject deletion of a fully-refunded invoice. The company already
        # paid the refund amount; removing the invoice would erase the audit
        # record and cause company_refunded_total to drift from actual payments.
        # The refund status must be explicitly cleared before the invoice can be deleted.
