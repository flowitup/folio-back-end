...
from app.application.billing._helpers import _assert_owner, _converted_facture_id
...
class GetBillingDocumentUseCase:
    ...
    def execute(self, doc_id: UUID, user_id: UUID) -> BillingDocumentResponse:
        ...
        return BillingDocumentResponse.from_entity(doc, _converted_facture_id(self._doc_repo, doc))
